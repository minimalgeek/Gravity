...
public class LevelEditorGUI : EditorWindow
{
    ...
    bool levelObjectsFoldoutState = true;
                    ...
                    while (n < Catalog.Count)
                    {
                        ...
                        using (var H = new EditorGUILayout.HorizontalScope())
                        {
                            ...
                            do
                            {
                                ...
                                w += catalogIconSize;
                                n++;
                            } while (n < inventory.Count && w < (position.width - catalogIconSize + 50));
                        }
                    }
    ...
    void CheckCatalog()
    {
        if (Catalog == null)
        {
            LevelEditorCatalog[] catalogs = Resources.FindObjectsOfTypeAll<LevelEditorCatalog>();
